...
def set_locctr(data, line):
    ...
    elif last_line["instruction"] == "BYTE" and last_line["args"][0] == "X":
        length = round(len(last_line["args"][2:-1]) / 2)
        line["locctr"] = last_locctr + length
...
def set_object_code(data, line: dict):
    ...
    elif line["instruction"] == "BYTE" and line["args"][0] == "X":
        args = line["args"][2:-1]
        line["object_code"] = args
...
def output_object_file(data: list):
